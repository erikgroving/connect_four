...
int getMoveScore (vector<spot> board, int rows, int cols, int move) {
    ...
    /*
    int my_best_score;
    int opponent_best_score;

    // Find my best score and opponent's best score
    if (my_horiz_chain >= my_vert_chain) {
        my_best_score = my_horiz_chain;
    }
    else {
        my_best_score = my_vert_chain;
    }
    if (my_best_score < my_diag_chain) {
        my_best_score = my_diag_chain;
    }

    if (opponent_horiz_chain >= opponent_vert_chain) {
        opponent_best_score = opponent_horiz_chain;
    }
    else {
        opponent_best_score = opponent_vert_chain;
    }
    if (opponent_best_score < opponent_diag_chain) {
        opponent_best_score = opponent_diag_chain;
    }

    return my_best_score + opponent_best_score;
*/
}
...
void getUpdate (string in, int& round, vector<spot>& board) {
    string line;
    string row_str;
